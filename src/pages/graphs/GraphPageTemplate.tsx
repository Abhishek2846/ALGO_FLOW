  ...
  return (
    <motion.div initial="hidden" animate="show" variants={containerVariants} style={{ background: 'rgba(8,9,14,1)', minHeight: '100vh', color: '#e2e8f0', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ padding: '2rem var(--gutter)', maxWidth: 1400, margin: '0 auto' }}>
        ...
        {/* Hero Header */}
        <motion.div variants={itemVariants} style={{ marginBottom: '3rem', display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'center', justifyContent: 'space-between', background: 'radial-gradient(ellipse at top left, rgba(239, 100, 97, 0.15), transparent 70%)', padding: '2rem', borderRadius: '1rem', border: '1px solid rgba(239, 100, 97, 0.2)', boxShadow: '0 8px 32px rgba(0,0,0,0.4)' }}>
          <div style={{ flex: '1 1 500px' }}>
            ...
            <h1 style={{ fontFamily: 'var(--font-headline)', fontSize: 'clamp(2rem, 4vw, 3.5rem)', fontWeight: 800, margin: '0 0 1rem 0', background: 'linear-gradient(135deg, #ffffff, #ef6461)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '-0.02em' }}>
              {meta.name}
            </h1>
